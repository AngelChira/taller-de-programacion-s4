#   Semana 04 Taller de Programación 
Este repositorio es sobre la tarea de la semana 04 del curso de taller de programación
...
```
https://github.com/AngelChira/taller-de-programacion-s4
```

2. Abrir el Apache NetBeans y seleccionar "Open Project" en la parte superior izquierda
3. Navega hasta la ubicación del proyecto "semana04" y haz 2 click en el proyecto.
